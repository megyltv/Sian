...
/* Created on:     19/08/2016 12:12:30                          */
/*==============================================================*/
...
create table HORARIO_MATERIA (
   IDMATERIAHORARIO     INT4                 not null,
   IDMATERIA            INT4                 not null,
   IDHORARIO            INT4                 not null,
   ESTADO               INT4                 null,
   constraint PK_HORARIO_MATERIA primary key (IDMATERIAHORARIO)
);
...
alter table INSCRIPCION
   add constraint FK_INSCRIPC_SE_HORARIO_ foreign key (IDMATERIAHORARIO)
      references HORARIO_MATERIA (IDMATERIAHORARIO)
      on delete restrict on update restrict;
